...
export const IconWhale       = icon('M4 14c0-4.4 3.6-8 8-8s8 3.6 8 8 M2 17c1-1.5 2.5-2 4-1.5 M22 17c-1-1.5-2.5-2-4-1.5 M12 6V3 M9 4l3-1 3 1')
export const IconArbitrage   = icon('M7 16l-4-4 4-4 M17 8l4 4-4 4 M14 4l-4 16')
